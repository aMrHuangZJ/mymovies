    ...
    <div class="search_body">
        ...
        <div class="search_result">
            ...
            <ul>
                ...
                <li v-for="item in moviesList" :key="item.cityId">
                    <!-- <div class="img"><img :src="item.img | setWH('128.180')"></div>
                    <div class="info">
                        <p><span>{{item.nm}}</span><span>{{item.sc}}</span></p>
                        <p>{{item.enm}}</p>
...
export default {
   ...
   watch : {
      message(newVal){
            console.log(newVal)
            // this.axios.get('/ajax/search?kw=dain&cityId=1&stype=-1'+newVal)
            // .then((res)=>{
            //     // var msg = res.data.msg;
            //     // var movies = res.data.movies;
            //     // if(msg && movies){
            //     //     this.moviewsList = res.data.movies.list;
            //     // }             
    ...
    this.moviesList = res.data.data.cities;
